...
tl.from(bgd, 0.2, {opacity:0, scale:0, transformOrigin: 'center center'})
	.staggerFrom(table, 0.2, {y:"-=200", opacity: 1, ease: Elastic.easeOut}, 0.1)
	...
	.to(lampLight, 0.15, {opacity:0.1, ease: Elastic.easeOut, delay:0.5}, "a")
    .to(lampLight, 0.15, {opacity:0.2, ease: Elastic.easeOut}, "b")
    .to(lampLight, 0.15, {opacity:0.3, ease: Elastic.easeOut}, "c")
